...
import EventService from "../../Services/CandidateService";
      ...
      <Content>
        ...
        <TabContent>
          ...
          {candidates.map((candidate, index) => {
            ...
            if (((query1 == "" && query2 == "") || (query2 != "" && candidate.status.match(query2)) || (query1 != "" && candidate.name.match(query1))) && (candidate.email.match(user.email))) {
              return (
                <Card key={index}>
                  <TextInfo>
