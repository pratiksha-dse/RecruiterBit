...
const Navbar = (props) => {
  ...
  const authenticatedNavBar = () => {
    return (
      <>  <NavLink href="#about">Home</NavLink>
      <NavLink href="#candidate">Candidate Details</NavLink>
      <NavLink href="#addcandidatedetails">Add Candidate Details</NavLink>
      </>
    );
  };
  const adminNavBar = () => {
    return (
      <>
        <NavLink href="#about">Home</NavLink>
        <NavLink href="#admin_candidates">Candidates</NavLink> 
      </>
    );
  };
